...
- ![](img/crossword1b.png){:style="float:left;margin-right:50px" .noborder} 
...
- {:.fragment data-fragment-index="1" .nospace-fragment .current-visible} Colour *WA* red \\(\Longrightarrow\\) *NT* and *SA* cannot be red
